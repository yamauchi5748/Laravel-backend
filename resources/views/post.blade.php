...
<div class="container">
  ...
  Laravel5.2<br>
  タイムカプセル投稿デモンストレーション<br>
  <form action="/api/v1/timecapsule/14" method="post">
  @csrf
    <p>
    年代：<select name="age">
                <option value="">-</option>
    ...
    <p>
    <input type="text" name="file_path" value="var/tmp/..">
    </p>
    <p>
  ...
  <br>
  <form action="/api/v1/timecapsule" method="get">
  @csrf
    <p>
    年代：<select name="start">
                <option value="">-</option>
                <option value="1971">1971</option>
                <option value="1972">1972</option>
                <option value="1973">1973</option>
...
<script>
  ...
  // リクエストをセットアップします
  XHR.open('POST', 'localhost:8000/api/v1/timecapsule/2');
